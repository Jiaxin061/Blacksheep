...
|-------------|-----------------|---------------|--------------|
| **1** | **Stray Animal Reporting Module** | **Page:**<br>• [`ReportAnimalScreen`](https://github.com/Jiaxin061/Blacksheep/blob/Karen/SavePawsFrontend/src/screens/ReportAnimalScreen.js)<br>• [`ViewReportsScreen`](./SavePawsFrontend/src/screens/ViewReportsScreen.js)<br>•[`AdminDashboardScreen`](./SavePawsFrontend/src/screens/AdminDashboardScreen.js)<br>• [`AdminManageScreen`](./SavePawsFrontend/src/screens/AdminManageScreen.js)<br><br>**Components & Services:**<br>• [`api.js`](./SavePawsFrontend/src/services/api.js)<br>• [`constants.js`](./SavePawsFrontend/src/utils/constants.js)<br>• [`AppNavigator.js`](./SavePawsFrontend/src/navigation/AppNavigator.js)|  **Controllers:**<br>•[`reportController.js`](./SavePawsBackend/controllers/reportController)<br><br>**Routes:**<br>• [`reports.js`](./SavePawsBackend/routes/reports.js)<br><br>**Models:**<br>• [`Report.js`](./SavePawsBackend/models/Report) <br><br>**Configuration:**<br>• [`database.js`](./SavePawsBackend/config/database.js)<br>• [`initDatabase.js`](./SavePawsBackend/config/initDatabase.js)<br>**Middleware:**<br>• [`logger.js`](./SavePawsBackend/middleware/logger.js)<br>• [`errorHandler.js`](./SavePawsBackend/middleware/errorHandler.js) |
