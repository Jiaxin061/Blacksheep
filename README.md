...
|-------------|-----------------|---------------|--------------|
| **1** | **Stray Animal Reporting Module** | **Page:**<br>• [`ReportAnimalScreen`](./SavePawsFrontend/src/screens/ReportAnimalScreen.js)<br>• [`ViewReportsScreen`](./SavePawsFrontend/src/screens/ViewReportsScreen.js)<br>• [`AdminDashboardScreen`](./SavePawsFrontend/src/screens/AdminDashboardScreen.js)<br>• [`AdminManageScreen`](./SavePawsFrontend/src/screens/AdminManageScreen.js)<br>• <br>**Components & Services:**<br>• [`api.js`](./SavePawsFrontend/src/services/api.js)<br>• [`constants.js`](./SavePawsFrontend/src/utils/constants.js)<br>• [`AppNavigator.js`](./SavePawsFrontend/src/navigation/AppNavigator.js)|  **Controllers:**<br>• [`reportController.js`](./SavePawsBackend/controllers/reportController.js)<br><br>**Routes:**<br>• [`reports.js`](./SavePawsBackend/routes/reports.js)<br> <br><br>**Models:**<br>• [`Report.js`](./SavePawsBackend/models/Report.js) <br><br>**Configuration:**<br>• [`database.js`](./SavePawsBackend/config/database.js) - MySQL connection<br>• [`initDatabase.js`](./SavePawsBackend/config/initDatabase.js) - Database setup<br><br>**Middleware:**<br>• [`logger.js`](./SavePawsBackend/middleware/logger.js)<br>• [`errorHandler.js`](./SavePawsBackend/middleware/errorHandler.js) |
