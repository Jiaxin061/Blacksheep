...
// UC05: Get all animal records (Public - no auth required for viewing)
...
// UC05: Get single animal record by ID (Public - no auth required for viewing)
...
// UC06: Search and filter animal records (Public - no auth required for viewing)
