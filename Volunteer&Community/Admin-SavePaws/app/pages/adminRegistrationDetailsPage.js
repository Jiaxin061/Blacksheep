...
export default function AdminRegistrationDetailsPage() {
    ...
    const { approveRegistration, rejectRegistration, loading } = useAdminRegistrationController();
    ...
    const handleApprove = async () => {
        const success = await approveRegistration(regData.registrationID);
        if (success) {
    ...
    const handleReject = async () => {
        ...
        const success = await rejectRegistration(regData.registrationID, rejectionReason);
        if (success) {
