import { useFocusEffect, useRouter, Stack } from "expo-router"; // Added Stack
...
export default function AdminAnimalsScreen() {
  ...
  const loadAnimals = useCallback(async () => {
    try {
      ...
      console.error("Admin animals fetch error:", err);
  ...
  return (
    <View style={styles.container}>
      ...
      <Stack.Screen options={{ title: "Animal Profile" }} />
