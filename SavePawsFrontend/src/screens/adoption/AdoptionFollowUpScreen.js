    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.customHeader}>
                <TouchableOpacity
                    style={[styles.headerTab, activeTab === 'submit' && styles.activeHeaderTab]}
                    onPress={() => setActiveTab('submit')}
                >
                    <Text style={[styles.headerTabText, activeTab === 'submit' && styles.activeHeaderTabText]}>Submit Update</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.headerTab, activeTab === 'history' && styles.activeHeaderTab]}
                    onPress={() => setActiveTab('history')}
                >
                    <Text style={[styles.headerTabText, activeTab === 'history' && styles.activeHeaderTabText]}>My Updates</Text>
                </TouchableOpacity>
            </View>
